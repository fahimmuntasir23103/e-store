    ...
    <section className="2xl:max-w-[1280px] mx-auto">
      <div className="grid grid-cols-2 overflow-hidden">
        <div className="grid grid-cols-1">
          <div>
            <div className="flex items-center justify-start gap-16.5 -translate-x-1/9">
          ...
          <div className="grid grid-cols-2">
            <div className="relative flex items-center bg-[#EDEDED] p-4">
              <div className="absolute xl:-left-2/5 -left-1/2">
                <img className="" src={Headset} alt="" />
              </div>
              <div className="text-[#909090] pl-30 py-16">
            ...
            <div className="relative flex items-center overflow-hidden bg-[#353535] p-4">

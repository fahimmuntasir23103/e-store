            ...
            <div className="2xl:max-w-[1280px] lg:max-w-[1120px] py-4 px-4 flex justify-between items-center mx-auto">
                ...
                <nav className="flex items-center gap-8">
                    ...
                    <ul className="hidden md:flex items-center gap-6 lg:gap-10 text-base">
                        <li className="cursor-pointer hover:text-gray-900 duration-200">Home</li>
                        <li className="text-[#b5b5b5] cursor-pointer hover:text-gray-900 duration-200">About</li>
                        <li className="text-[#b5b5b5] cursor-pointer hover:text-gray-900 duration-200">Contact Us</li>
                        <li className="text-[#b5b5b5] cursor-pointer hover:text-gray-900 duration-200">Blog</li>
                    </ul>
                    ...
                    <div className="flex items-center gap-4 lg:gap-6">
                        ...
                        <FiUser className="cursor-pointer hidden sm:block hover:text-gray-900 duration-200" size={28} />
            ...
            <div className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${isMenuOpen ? "max-h-screen opacity-100" : "max-h-0 opacity-0"}`}>
                <div className="bg-white px-4 pb-6 flex flex-col gap-4 border-t border-gray-100 shadow-lg absolute w-full left-0">
                    ...
                    <ul className="flex flex-col gap-4 text-base font-medium">
                        <li className="cursor-pointer border-b border-gray-50 pb-2 hover:text-gray-900">Home</li>
                        <li className="text-[#b5b5b5] cursor-pointer border-b border-gray-50 pb-2 hover:text-gray-900">About</li>
                        <li className="text-[#b5b5b5] cursor-pointer border-b border-gray-50 pb-2 hover:text-gray-900">Contact Us</li>
                        <li className="text-[#b5b5b5] cursor-pointer hover:text-gray-900">Blog</li>

    ...
    <div className="h-screen flex flex-col items-center justify-center bg-white px-6">
      <div className="w-full max-w-[400px]">
        <div className="mb-10">
          ...
          <p className="text-sm text-gray-500 mt-1">Enter your email and password to login</p>
        </div>
        ...
        <form className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              />
              <Link to="/forgot" className="text-xs font-medium text-gray-400 hover:text-black ml-1 ">Forgot password?</Link>
              <button 
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-4 bottom-1/2 text-gray-400 hover:text-black transition-colors"
              >
        ...
        <p className="text-center text-sm text-gray-500">
          Don't have an account? <Link to="/register" className="font-bold text-black underline underline-offset-4">Sign up</Link>
        </p>
      </div>
    </div>
  );
